...
public class GrassComputeScript : MonoBehaviour
{
    ...
    [Range(-1, 1)] public float FadeOffset = 0.1f;
    public Color topTint = new Color(1, 1, 1);
    public Color bottomTint = new Color(0, 0, 1);
    public Color ReflectionColor = new Color(0, 0, 1);
    public float Lighing;
    [Range(-1,1)]public float RadiusOfReflction;
    public float GrassLenghtRef;
    ...
    private void SetGrassDataBase()
    {
        ...
        m_InstantiatedMaterial.SetColor("_RefColor", ReflectionColor);
        m_InstantiatedMaterial.SetColor("_BottomTint", bottomTint);
        m_InstantiatedMaterial.SetFloat("_Fade", FadeOffset);
        m_InstantiatedMaterial.SetFloat("_GrassLenghtRef", GrassLenghtRef);
        m_InstantiatedMaterial.SetFloat("_LightRef", Lighing);
        m_InstantiatedMaterial.SetFloat("_Radius", RadiusOfReflction);
    }
